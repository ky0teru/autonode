...
- 64 MB socket buffers, tuned `tcp_rmem`/`tcp_wmem` for high-BDP links — exceeds the
  16 MB UDP buffer requirement of Hysteria2/QUIC by 4x
...
- **Ports:** 22 (SSH), 80, 443 (TCP and UDP) free; node API port (default `2222`)
